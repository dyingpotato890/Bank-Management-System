...
def customer_details(cur):
    ...
    cur.execute("insert into customer_details values('C001',952090760,'Liam Mitchell','M',20,'+97156165182','daroya2827@jahsec.com',9000)")
    cur.execute("insert into customer_details values('C002',970439492,'Emma Collins','F',19,'+919747159682','daroya2827@jahsec.com',6600)")
    conn.commit()
...
def admin_details(cur):
    ...
    cur.execute("insert into admin_details values('A001','Ethan Bennett','Owner','2022-01-02')")
    cur.execute("insert into admin_details values('A002','Olivia Hayes','Manager','2022-01-02')")
    conn.commit()
...
def add_admin(cur):
    ...
    file_path = os.path.join("Python\\Bank Management System", 'adminlogin.csv')
...
def add_customer(cur):
    ...
    file_path = os.path.join("Python\\Bank Management System", 'customerlogin.csv')
